          ...
          <div className="flex flex-row gap-8">
            ...
            <div className="space-y-4">
              ...
              <p>
                ...
                young minds from various disciplines across campus. With a
                vision to foster impactful technological innovations and inspire
                students to approach real-world problems with fresh
                perspectives, TDH provides the ideal platform for collaborative
                innovation.
              </p>
              ...
              <p>
                ...
                projects, we equip our members with the knowledge and tools
                needed to tackle complex challenges head-on. Our mission is not
                only to promote human-centered design but also to facilitate
                interdisciplinary collaboration and contribute to the
              ...
              <p>
                ...
                cutting-edge technology with human-centered design principles.
                By harnessing their diverse talents and perspectives, our
                members work together to develop innovative solutions that
                address the needs and aspirations of communities both locally
                and globally.
              </p>
              <p>
                Join TDH and be part of a vibrant community dedicated to
                harnessing the power of innovation to shape a brighter future
                for all.
              </p>
